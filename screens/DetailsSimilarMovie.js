...
import TabTrailer from '../components/homeList/detailstabScreen/TabTrailer';
import TabSimilar from '../components/homeList/detailstabScreen/TabSimilar';
...
import { 
 ...
 class DetailsSimilarMovie extends React.PureComponent {
   ...
   constructor(props) {
     ...
     this.onPressTabTrailer = this.onPressTabTrailer.bind(this);
     this.onPressTabSimilar = this.onPressTabSimilar.bind(this);
  ...
  componentDidMount() {
    ...
    const urlSimilar = `https://api.themoviedb.org/3/movie/${this.props.navigation.state.params.id}/similar?api_key=${Config.API_KEY}`;
    //---------------------------------------------------------------------------->
    ...
    console.log('DetailsMovie#componentDidMount//urlSimilar : ', urlSimilar);
    ...
    /////////////////////////////[ F E T C H : S I M I L A R ]/////////////////////////////////
      fetch(urlSimilar)
      .then(res => res.json())
      .then(data => {
        console.log('DetailsMovie#componentDidMount//urlSimilar data: ', data);
        this.setState({
          isLoading: false,
          dataSourceSimilar: data.results
        })
        .catch((error) => {
          console.error(error);
      });
  ...
  render() {
    ...
    const { dataSourceTrailers, dataSourceCredits, dataSourceAllInfo , dataSourceGenres, dataSourceSimilar } = this.state;
        ...
        <ScrollView style={Styles.container}>
          ...
          <View style={Styles.separator}>
            ...
            <View style={{justifyContent:"space-around", flexDirection:'row'}}>
             ...
             {this.state.activeTab === 'trailer' && <TabTrailer dataSourceTrailers={dataSourceTrailers} poster_path={poster_path} title={title} date={date} genre_1={genre_1} genre_2={genre_2} genre_3={genre_3}/>} 
             {this.state.activeTab === 'similar' && <TabSimilar dataSourceSimilar={dataSourceSimilar} dataSourceTrailers={dataSourceTrailers} creator_1={creator_1} creator_2={creator_2} actor_1={actor_1} actor_2={actor_2} actor_3={actor_3} genre_1={genre_1} genre_2={genre_2} genre_3={genre_3}/>} 
