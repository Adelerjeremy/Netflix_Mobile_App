...
import { 
 ...
 class DetailsSerie extends React.Component {
   ...
   constructor(props) {
    ...
    //  this.getWorkLink=this.getWorkLink.bind(this)
   }

  componentDidMount() {

    console.log('>> DetailsSerie#componentDidMount');
    const url = `https://api.themoviedb.org/3/tv/${this.props.navigation.state.params.id}/videos?api_key=${Config.API_KEY}`;
    console.log('DetailsSerie#componentDidMount//url: ', url)
    console.log('DetailsSerie#componentDidMount//this.props.navigation.state.params.id: ', this.props.navigation.state.params.id)

    fetch(url)
      .then(res => res.json())
      .then(data => {
        console.log('DetailsSerie#Popular#componentDidMount data: ', data);
...
//         return data.results;
//     }
//     console.log('DetailsSerie#getWorkLink :', data.results)
//     console.log('DetailsSerie#getWorkLink :', data.results[0])
//   }
  ...
  render() {
    ...
    console.log('DetailsSerie#render()//dataSource.key: ', dataSource.key)
    console.log('>> DetailsSerie#render()');
    console.log('DetailsSerie#render()/this.props ', this.props);
    console.log('DetailsSerie#render()/this.props.navigation.state.params ', this.props.navigation.state.params)

    /////////////////////////////////////////
    /////////[ TARGET ANNEE UNIQUEMENT]//////
    let getDate = first_air_date;
...
export default withNavigation(DetailsSerie);  
